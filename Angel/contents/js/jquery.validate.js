...
$.extend($.validator, {
	...
	messages: {
		...
		alphanumeric:"Please enter alpha numeric only",
	...
	methods: {
		...
		username: function(value, element) {
			// contributed by Scott Gonzalez: http://projects.scottsplayground.com/name_validation/
			//return this.optional(element) || /^[a-z\d\s]{1,28}$/i.test(value);
			return this.optional(element) ||/^[a-z][\.a-z ]{0,30}$/i.test(value);//only for name
		},
